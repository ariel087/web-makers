        ...
        <div class="box1">
            <form action="" method="post">
                ...
                <div class="Birthday">
                    ...
                    <div class="gender">
                        <input type="radio" name="gender" id="Male" name="Male" value="Male" checked><Label>Male</Label>
                        <input type="radio" name="gender" id="Female" name="Female" value="Female" ><Label>Female</Label>
                        <input type="radio" name="gender" id="Custom" name="Costom" value="Custom" ><Label>Custom</Label>
                    </div>
                <div class="submit">
